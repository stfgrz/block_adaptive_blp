% SMOKE_TEST_EMPIRICAL_V1  Interface check for the LEGACY v1 driver
% (RUN_EMPIRICAL_V1, surprise inside the VAR).  Moved to empirical/legacy_v1/
% on 2026-09-15; the current design is RUN_EMPIRICAL_IV (QUICK = true is its
% own interface check).
%
% PURPOSE
% -------
...
if isempty(ea_this), ea_this = fullfile(pwd, 'SMOKE_TEST_EMPIRICAL_V1'); end
...
fprintf('RUN_EMPIRICAL_V1 should run clean; launch it with:\n');
fprintf('    RUN_EMPIRICAL_V1\n\n');
