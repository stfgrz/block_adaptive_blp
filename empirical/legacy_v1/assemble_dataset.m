...
%
% SYSTEM (K = 5, ordering = identification; see docs/DESIGN_V1_LEGACY.md Sec. 2)
% -----------------------------------------------------------------------
...
%   README.md), ds.shock_variant, ds.meta, and
...
opts = set_default(opts, 'out_mat', P.dataset_legacy);   % v1 five-variable dataset
