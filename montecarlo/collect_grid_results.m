...
T = struct('name', {}, 'axis', {}, 'dgp', {}, 'label', {}, 'R', {}, ...
           ...
           'detect_prob_best_eq', {}, 'flag_rate', {}, ...
           'false_positive_setting', {}, 'max_concentration_early', {}, ...
           'verdict_block', {}, 'verdict_pooled', {});
...
for k = 1:numel(d)
    ...
    T(e).flag_rate = flagr;
    T(e).false_positive_setting = fp;
    T(e).max_concentration_early = conc;
...
for e = 1:numel(T)
    fprintf(fid, '%s,%s,%s,%g,%g,%g,%g,%.6g,%.6g,%.6g,%.4f,%.4f,%.4f,%.4f,%.3f,%.3f,%.3f,%g,%.3f,%s,%s,"%s"\n', ...
        ...
        T(e).flag_rate, T(e).false_positive_setting, T(e).max_concentration_early, ...
        T(e).verdict_block, T(e).verdict_pooled, T(e).label);
end
fclose(fid);
